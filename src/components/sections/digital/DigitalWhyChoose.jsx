...
const whatsappMessage = encodeURIComponent(
  "Hello Hill City Media, I would like to discuss a Digital Marketing project."
);
...
const reasons = [
  {
    number: "01",
    title: "Strategy",
    description: "We don't just post. We build with purpose.",
    icon: Target,
  },
  {
    number: "02",
    title: "Creative",
    description: "Content that looks good and gets attention.",
    icon: Palette,
  },
  {
    number: "03",
    title: "Consistency",
    description: "Your brand stays active and recognizable.",
    icon: RefreshCw,
  },
  {
    number: "04",
    title: "Results",
    description: "Every campaign has a clear objective.",
    icon: BarChart3,
  },
];

export default function DigitalWhyChoose() {
  return (
        ...
        <div className="grid items-start gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          ...
          >
            ...
            <h2 className="font-montserrat text-4xl font-black leading-[1.02] tracking-[-0.04em] sm:text-5xl lg:text-[4.2rem]">
              More than
              <span className="block text-[#e50914]">content.</span>
              <span className="block">We build impact.</span>
            </h2>

            <p className="mt-6 max-w-lg font-poppins text-sm leading-7 text-white/50 sm:text-base">
              Digital marketing is not about being everywhere. It's about
              being where your audience is, saying the right thing, and giving
              people a reason to choose your brand.
            </p>
            ...
            {reasons.map((reason, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 max-w-xs font-poppins text-sm leading-6 text-white/45">
                    {reason.description}
                  </p>
          ...
          <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-xl font-poppins text-sm leading-6 text-white/45">
                Let's turn your ideas into a digital presence that gets
