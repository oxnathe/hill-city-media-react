...
const printingServices = [
  {
    ...
    description: "Professional cards that make every introduction count.",
    message: "Hello Hill City Media, I'm interested in Business Cards printing. I'd like to get a quote.",
    icon: CreditCard,
    image: "/images/printing/business-cards.jpeg",
  },
  {
    number: "02",
    title: "Flyers & Brochures",
    description: "Promotional materials designed to communicate clearly.",
    message: "Hello Hill City Media, I'm interested in Flyers & Brochures printing. I'd like to get a quote.",
    icon: FileText,
    image: "/images/printing/flyers-brochures.png",
  },
  {
    number: "03",
    title: "Banners & Posters",
    description: "Large-format prints built to get attention.",
    message: "Hello Hill City Media, I'm interested in Banners & Posters printing. I'd like to get a quote.",
    icon: Flag,
    image: "/images/printing/banners-posters.png",
  },
  {
    number: "04",
    title: "Packaging",
    description: "Branded packaging that adds value to your product.",
    message: "Hello Hill City Media, I'm interested in Packaging printing. I'd like to get a quote.",
    icon: Package,
    image: "/images/printing/packaging.jpeg",
  },
  {
    number: "05",
    title: "Stickers & Labels",
    description: "Custom labels and stickers for products, packaging and promotions.",
    message: "Hello Hill City Media, I'm interested in Stickers & Labels printing. I'd like to get a quote.",
    icon: Sticker,
    image: "/images/printing/stickers-labels.png",
  },
  {
    number: "06",
    title: "Custom Print",
    description: "Have something specific in mind? Let's bring it to print.",
    message: "Hello Hill City Media, I have a custom printing project I'd like to discuss and get a quote for.",
    icon: ImageIcon,
    image: "/images/printing/custom-print.jpg",
  },
];
...
export default function PrintingServicesOverview() {
  ...
  const handleImageError = (number) => {
    setFailedImages((prev) => ({ ...prev, [number]: true }));
  };
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <h2 className="font-oswald text-5xl font-semibold uppercase leading-[0.9] tracking-tight sm:text-6xl lg:text-7xl">
              Print it.
              <span className="block text-[var(--hill-red)]">Make it real.</span>
            </h2>
          </div>

          <p className="max-w-md font-poppins text-sm leading-7 text-black/50 md:text-right">
            From everyday business essentials to large-format campaigns, we turn
            your ideas into physical brand experiences.
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {printingServices.map((service, index) => {
            ...
            const hasError = failedImages[service.number];
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0">
                  {service.image && !hasError ? (
                    <img
                      src={service.image}
                      alt={service.title}
                      onError={() => handleImageError(service.number)}
                      className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
                    />
                  ) : (
                    /* Fallback design when image is loading or missing */
                    <>
                ...
                <div className="absolute left-5 top-5 z-10">
                  <span className="font-oswald text-xs font-bold text-white/70">
                    {service.number}
                  </span>
                </div>
                ...
                {/* CONTENT PANEL */}
                <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-black via-black/95 to-transparent p-6 pt-12">
        ...
        >
          <div>
            ...
            <p className="mt-2 max-w-md font-poppins text-xs leading-6 text-white/40">
              Tell us what you have in mind and we&apos;ll help you find the
              right printing solution.
            </p>
          </div>
