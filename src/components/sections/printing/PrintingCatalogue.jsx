...
const products = [
  {
    ...
    description:
      "Professional business cards designed to make every introduction count.",
    image: null,
  },
  {
    id: 2,
    ...
    category: "Business Stationery",
    description:
      "Clean and professional letterheads that keep your business communication on brand.",
    image: null,
  },
  {
    id: 3,
    ...
    category: "Business Stationery",
    description:
      "Branded envelopes that give your business correspondence a polished finish.",
    image: null,
  },
  {
    id: 4,
    ...
    category: "Business Stationery",
    description:
      "Well-designed brochures that present your products, services and story clearly.",
    image: null,
  },
  {
    id: 5,
    ...
    description:
      "High-impact flyers created to promote events, products, offers and campaigns.",
    image: null,
  },
  {
    id: 6,
    ...
    category: "Marketing Materials",
    description:
      "Bold promotional posters designed to capture attention from a distance.",
    image: null,
  },
  {
    id: 7,
    ...
    category: "Marketing Materials",
    description:
      "Custom stickers and labels for packaging, branding, promotions and products.",
    image: null,
  },
  {
    id: 8,
    ...
    category: "Marketing Materials",
    description:
      "Branded calendars that keep your business visible throughout the year.",
    image: null,
  },
  {
    id: 9,
    ...
    description:
      "Portable display banners built for exhibitions, events, offices and promotions.",
    image: null,
  },
  {
    id: 10,
    ...
    category: "Large Format",
    description:
      "Large-format branded backdrops for events, photo walls, launches and activations.",
    image: null,
  },
  {
    id: 11,
    ...
    category: "Large Format",
    description:
      "Durable large-format banners suitable for outdoor and indoor promotions.",
    image: null,
  },
  {
    id: 12,
    ...
    category: "Large Format",
    description:
      "Professional signage solutions designed to make your physical space stand out.",
    image: null,
  },
  {
    id: 13,
    ...
    description:
      "Custom branded T-shirts for teams, events, campaigns and promotional activities.",
    image: null,
  },
  {
    id: 14,
    ...
    category: "Apparel & Merchandise",
    description:
      "Professional branded polos that turn your team into walking brand ambassadors.",
    image: null,
  },
  {
    id: 15,
    ...
    category: "Apparel & Merchandise",
    description:
      "Custom mugs created for corporate gifts, events and promotional campaigns.",
    image: null,
  },
  {
    id: 16,
    ...
    category: "Apparel & Merchandise",
    description:
      "Thoughtful branded souvenirs designed to keep your business memorable.",
    image: null,
  },
];
...
export default function PrintingCatalogue() {
  ...
  /*
   * Check whether the category container
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-6 max-w-2xl font-['Poppins'] text-sm leading-7 text-black/50 sm:text-base">
                From everyday business stationery to large-format
                displays and branded merchandise, we create print
                materials that make your brand impossible to overlook.
              </p>
            </div>
          ...
          <AnimatePresence>
            {canScrollRight && (
              <motion.button
                ...
                className="absolute right-0 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 justify-center items-center rounded-full border border-black/10 bg-white shadow-lg lg:hidden"
              >
                <motion.div
                  animate={{
                    x: [0, 4, 0],
            ...
            <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
              <div>
                ...
                <p className="mt-3 max-w-xl font-['Poppins'] text-sm leading-6 text-white/40">
                  Have a custom print request or a project that isn't
                  listed? Send us a message and we'll help you figure
                  it out.
                </p>
              </div>
